  ...
  <head>
    ...
    <script type="text/javascript"> 
	    ...
	    //	var target = $('#'+elFaculty);
	    	target.empty();
	    	var opt = $("<option value='0'></option>").html("none");
	    	target.append(opt);
		...
		function actSearchOrg(el,level){
 		...
 		function createOption(targetId,lists){
   	 		...
   	 		target.empty();
   	 		var opt = $("<option></option>").html("none");
   	 		target.append(opt);
   	...
   	<style type="text/css">
		...
		.rectred{ background-color:red;}
		.rectgreen{ background-color:green;}
		#paramMain .boxFilter>span{ font-size:105%;display:inline-block;min-width:60px; text-align:right;}
		#paramMain .boxFilter>select.filterOrg{ min-width:250px; } 
   	</style>
  </head>
...
<body>
	...
	<div class="boxPage">
		...
		<!-- Parameter -->
		<div id="paramMain" style="display:inline-block; border:1px solid #C0C0C0; border-radius:5px;margin:5px 5px 5px 5px;padding:10px 10px 10px 10px;width:95%;">
			<div  style="">
